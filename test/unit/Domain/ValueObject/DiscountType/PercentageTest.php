 ...
 * @coversNothing
 */
final class PercentageTest extends \PHPUnit\Framework\TestCase
{
    /**
     * @var Configuration
     */
     ...
     */
    public function testApply(Basket $basket, int $discount, Price $expected)
    {
        $sut = new Percentage($discount);
